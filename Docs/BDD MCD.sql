# script créé le : Tue Nov 20 09:30:15 CET 2012 -   syntaxe MySQL ;
...
ALTER TABLE Produits ADD CONSTRAINT FK_Produits_id_commande FOREIGN KEY (id_commande) REFERENCES Commandes (id_commande);
